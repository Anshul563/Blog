      ...
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-10 text-sm text-gray-300">
        ...
        <div className="flex flex-col items-center md:items-start">
          <div className="bg-gradient-to-br from-purple-400 via-pink-400 to-blue-400 p-1 rounded-full mb-3 shadow-lg">
            <img src="/Logo.png" alt="Logo" className="h-10 w-45 rounded-full bg-white/80" />
          </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <ul className="space-y-2">
            <li><a href="/" className="hover:text-purple-400 transition-colors font-semibold">Home</a></li>
            <li><a href="/blogs" className="hover:text-purple-400 transition-colors font-semibold">Blogs</a></li>
            <li><a href="/contact" className="hover:text-purple-400 transition-colors font-semibold">Contact</a></li>
            <li><a href="/login" className="hover:text-purple-400 transition-colors font-semibold">Login</a></li>
          </ul>
        </div>
        ...
        <div className="flex flex-col items-center md:items-end">
          ...
          <div className="flex gap-4 mt-4">
            ...
            <a href="mailto:support@techblog.com" className="hover:text-pink-400 transition-colors text-xl"><svg fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5"><path d="M12 13.065L.015 6.5A2.003 2.003 0 0 1 2 4h20a2.003 2.003 0 0 1 1.985 2.5L12 13.065zm11.985-4.5l-9.985 6.565-9.985-6.565A1.993 1.993 0 0 0 0 6.5v11A2.5 2.5 0 0 0 2.5 20h19a2.5 2.5 0 0 0 2.5-2.5v-11a1.993 1.993 0 0 0-1.015-1.935z"/></svg></a>
          </div>
